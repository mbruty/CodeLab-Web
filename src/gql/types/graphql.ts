...
export type AuthCheckQuery = { __typename?: 'Query', me: { __typename?: 'User', id?: number | null, email: string, username: string, xp: number } };
...
export type GetCodeQuery = { __typename?: 'Query', programmingTask: { __typename?: 'ProgrammingTask', title: string, description: string, starterCode: string, testCode: string, language: string, availableLanguages?: Array<string | null> | null } };
...
export type EvaluateQuery = { __typename?: 'Query', evaluate: { __typename?: 'CodeResponse', output?: string | null, errorText?: string | null, isSuccessful: boolean, executionTimeMS: any, stats: Array<{ __typename?: 'Stat', mem: string } | null> } };
...
export type LoginMutationMutation = { __typename?: 'Mutation', login?: { __typename?: 'User', id?: number | null, email: string, username: string, xp: number } | null };

...
export type LoginMutationMutation = { __typename?: 'Mutation', login?: { __typename?: 'User', id?: number | null, email: string, username: string, refreshCount: number } | null };
			...
			"selections": [{
				...
				"selectionSet": {
					...
					"selections": [{"kind": "Field", "name": {"kind": "Name", "value": "id"}}, {
						...
						"kind": "Field",
						"name": {"kind": "Name", "value": "refreshCount"}
					}]
				}
			}]
		}
